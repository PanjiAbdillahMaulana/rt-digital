            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h1 mb-0 text-gray-800">Cetak <span style="color: #019147;">Surat Domisili</span></h1>
                    </div>
                    ...
                    <div class="container-sm">
                            ...
                            <form action="" method="post">
                                ...
                                <input type="hidden" name="nama_surat" value="Surat Domisili">
                                <div class="mb-3 px-5">
                                ...
                                <button type="submit" name="permintaan" class="btn btn-primary">Minta Surat Domisili</button>
                            </form>
                        </div>
                    </div>
            </div>
